/* Big thanks to Ashwin Sureshkumar
...
/**
 * Cache Service is an observableimport { HttpClient, HttpParams } from '@angular/common/http';
import { Observable } from 'rxjs/Rx'i based in-memory cache implementation
