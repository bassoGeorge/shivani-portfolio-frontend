///////////////////////////////////////////////////////////////////////////////
//        Fancy 3D waves effect using three.js                               //
///////////////////////////////////////////////////////////////////////////////
...
export class Waves3dComponent {

    ngOnInit2() {
        var SEPARATION = 100, AMOUNTX = 40, AMOUNTY = 20;

        var container;
        var camera:any, scene:any, renderer:any;

        var particles:any, particle, count = 0;
        ...
        function init() {
            ...
            container = document.getElementById('waves-3d');
    ...
    ngOnInit() {
        var mContainer;
        var mCamera:any, mRenderer:any;
        var mControls:any;

        var mScene:any;

        var mParticleCount = 100000; // <-- change this number!
        var mParticleSystem:any;
